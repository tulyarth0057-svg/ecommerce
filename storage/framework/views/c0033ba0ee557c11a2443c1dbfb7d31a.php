        ...
        <tbody>
            ...
            <tr>
              ...
              <td><?php echo e($category->mainCategory->cat_name ?? 'No Main Category'); ?></td>
                ...
                <td>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($category->c_banner_img): ?>
...
<?php echo $__env->make('layouts.admin-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laravel_git\ecommerce-web\resources\views/admin/categorylist.blade.php ENDPATH**/ ?>