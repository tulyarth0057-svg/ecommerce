...
<?php $__env->startSection('title', 'Update-courierboy-Profile'); ?>
    ...
    <div class="up-container">
        ...
        <div class="up-card">
            ...
            <form id="profileForm" class="up-form-body" novalidate>
                ...
                <input type="hidden" name="id" value="<?php echo e($courier->id); ?>">
...
<div class="up-avatar-section">
    <label for="rc_photo_input" class="up-avatar-ring">
       <img id="rcPreview"
             src="<?php echo e(asset('storage/' . $courier->vehicle_rc)); ?>"
             alt="Aadhar Photo">
...
<div class="up-avatar-section">
    <label for="aadhar_photo_input" class="up-avatar-ring">
        <img  id="aadharPreview"
             src="<?php echo e(asset('storage/' . $courier->id_proof)); ?>"
             alt="Aadhar Photo">
        <div class="up-avatar-overlay">
            <svg> <!-- same overlay icon as profile photo --> </svg>
        </div>
...
(function () {
    ...
    form.addEventListener('submit', function (e) {
        ...
        fetch("<?php echo e(route('courierboy.update')); ?>", {
            method: 'POST',
            headers: {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laravel_git\ecommerce-web\resources\views/admin/edit-courierboy.blade.php ENDPATH**/ ?>