...
<div class="order-container">
    ...
    <div class="card order-card mb-4">
        ...
        <div class="info-grid">
            <div class="info-item">
                ...
                <div class="info-value"><?php echo e($order->o_order_number); ?></div>
            </div>
            <div class="info-item">
            ...
            <div class="info-item">
                ...
                <div class="info-value"><?php echo e(ucfirst($order->o_payment_method)); ?></div>
            </div>
            <div class="info-item">
                <div class="info-label"><i class="ri-checkbox-circle-line"></i>Payment Status</div>
                <div class="info-value"><?php echo e(ucfirst($order->o_payment_status)); ?></div>
            </div>
            <div class="info-item">
                <div class="info-label"><i class="ri-money-rupee-circle-line"></i>Total Amount</div>
                <div class="info-value highlight">₹<?php echo e(number_format($grandTotal,2)); ?></div>
            </div>
            <div class="info-item">
                <div class="info-label"><i class="ri-truck-line"></i>Order Status</div>
                <div class="info-value" style="color: <?php echo e(strtolower($order->o_order_status) == 'completed' ? '#10b981' : (strtolower($order->o_order_status) == 'cancelled' ? '#ef4444' : '#f59e0b')); ?>">
    ...
    <div class="card order-card mb-4">
        ...
        <div class="address-content">
            <div class="address-item"><i class="ri-user-line"></i><div class="address-text"><div class="name"><?php echo e($order->o_name); ?></div></div></div>
            <div class="address-item"><i class="ri-mail-line"></i><div class="address-text"><div class="detail"><?php echo e($order->o_email); ?></div></div></div>
            <div class="address-item"><i class="ri-phone-line"></i><div class="address-text"><div class="detail"><?php echo e($order->o_phone); ?></div></div></div>
            <div class="address-item"><i class="ri-home-line"></i>
                <div class="address-text">
                    <div class="detail"><?php echo e($order->o_street_address); ?></div>
                    <div class="detail"><?php echo e($order->o_city); ?>, <?php echo e($order->o_state); ?> - <?php echo e($order->o_postcode); ?></div>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-md-4">
            <div class="position-relative h-100 bg-light d-flex align-items-center justify-content-center p-3">
                ...
                <span class="position-absolute top-0 end-0 m-2 badge 
                    <?php echo e(strtolower($order->o_order_status) == 'completed' ? 'bg-success' : 
                    ...
                    <i class="ri-checkbox-circle-fill me-1"></i><?php echo e(ucfirst($order->o_order_status)); ?>
        ...
        <div class="col-md-8">
            <div class="card-body p-3">
                ...
                <div class="d-flex justify-content-between align-items-start mb-3">
                    <h5 class="card-title mb-0 fw-bold"><?php echo e($item->o_i_product_name); ?></h5>
                ...
                <div class="row g-2 mb-3">
                    <div class="col-4">
                        <div class="border rounded p-2 text-center bg-light">
                            ...
                            <strong class="d-block"><?php echo e($item->o_i_quantity); ?></strong>
                        </div>
                    </div>
                    ...
                    <div class="col-4">
                        <div class="border rounded p-2 text-center bg-light">
                            ...
                            <strong class="d-block"><?php echo e($item->o_i_size ?? 'N/A'); ?></strong>
                        </div>
                    </div>

                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($item->color_code)): ?>
                    <div class="col-4">
                        <div class="border rounded p-2 text-center bg-light">
                            ...
                            <div class="d-flex justify-content-center mt-1">
                                <span class="rounded-circle border border-2 border-white shadow-sm" 
                                      style="width: 24px; height: 24px; background: <?php echo e($item->color_code); ?>; display: inline-block;"></span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="border overflow-hidden">
                    ...
                    <div class="p-3">
                        <div class="d-flex justify-content-between mb-2">
                            ...
                            <strong>₹<?php echo e(number_format($item->o_i_total_price, 2)); ?></strong>
                        </div>
                        <div class="d-flex justify-content-between mb-2">
                            <span class="text-muted">Shipping Charges</span>
                            <strong class="text-success">₹<?php echo e(number_format($order->o_shipping_cost / max(count($orderItems), 1), 2)); ?></strong>
                        </div>
                        <hr class="my-2">
                        <div class="d-flex justify-content-between">
                            <strong class="text-dark">Total Amount</strong>
                            <strong class=" totalprice fs-5">₹<?php echo e(number_format($item->o_i_total_price + ($order->o_shipping_cost / max(count($orderItems), 1)), 2)); ?></strong>
                        </div>
                    </div>
                </div>
            </div>
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
    ...
    <!-- Payment Status -->
    <button class="payment-status-btn <?php echo e(strtolower($order->o_payment_status) == 'paid' ? 'payment-paid' : 'payment-pending'); ?>">
        <i class="ri-secure-payment-line"></i> Payment <?php echo e(ucfirst($order->o_payment_status)); ?>
    ...
    <div class="action-buttons">
        ...
        <a href="<?php echo e(route ('order.list')); ?>" class="btn btn-orange-outline flex-fill"><i class="ri-map-pin-time-line"></i>Back to order list</a>
    </div>
