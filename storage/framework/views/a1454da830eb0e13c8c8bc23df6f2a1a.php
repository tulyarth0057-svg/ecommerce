...
<body>
                    ...
                    <div class="dropdown user-profile ml-2 ml-sm-3 d-flex align-items-center zindex-popover">
                        ...
                        <div class="dropdown me-3">
                            <a class="notification-icon"
                               ...
                               data-bs-toggle="dropdown">
                                ...
                                <span id="courierCount"
                                    ...
                                    <?php echo e($courierNotifications->count()); ?>
                            ...
                            <div class="dropdown-menu dropdown-menu-end shadow"
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $courierNotifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                    <a href="<?php echo e(route('courierboys.view', $courier->id)); ?>"
                        ...
                        <a class="nav-link dropdown-toggle pulse p-0"
                           ...
                           data-bs-display="static">
                            <img class="avatar lg rounded-circle img-thumbnail"
                                 src="<?php echo e(asset('assetsofdash/images/profile_av.svg')); ?>"
                                 alt="profile">
                        </a>
    ...
    let lastOrderCount = <?php echo e($notifications->count()); ?>;
    let lastCourierCount = <?php echo e($courierNotifications->count()); ?>;
...
</html><?php /**PATH E:\laravel_git\ecommerce-web\resources\views/partials/header.blade.php ENDPATH**/ ?>