<?php $__env->startSection('title', 'toys collection'); ?>
...
<?php $__env->startSection('content'); ?>
     ...
     style="background-image: url('<?php echo e(asset('category_banners/1764654522_baby-items-banner.webp')); ?>');
    ...
    <div class="container">
        ...
        <h2 class="extra-color font-24 font-xl-32 mst-5 mst-xl-9">Toys & Games Collection</h2>
    </div>
</div>
...
<?php echo $__env->make('layouts.frontend-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laravel_git\ecommerce-web\resources\views/kidstoyscollection1.blade.php ENDPATH**/ ?>