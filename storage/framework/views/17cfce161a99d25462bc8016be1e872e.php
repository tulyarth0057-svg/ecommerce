                                ...
                                <div class="swiper-wrapper">
                                   <div class="swiper-slide h-auto d-flex" data-animate="animate__fadeIn">
                                        <div class="cat-block banner-hover w-100 ptb-15 plr-15 body-bg border-radius">
                                            <a href="<?php echo e(route('kidscollection1')); ?>" class="d-none d-xl-block position-relative banner-img br-hidden">
                                    ...
                                    <div class="swiper-slide h-auto d-flex" data-animate="animate__fadeIn">
                                        <div class="cat-block banner-hover w-100 ptb-15 plr-15 body-bg border-radius">
                                            <a href="<?php echo e(route('kidscollection2')); ?>" class="d-none d-xl-block position-relative banner-img br-hidden">
                                                <span class="btn-style tertiary-btn banner-btn position-absolute top-50 start-50 translate-middle z-1 text-nowrap">Shop now</span>
                                                  <img src="category_images/1764657243_kurta-pajama-pink-1.webp" class="w-100 img-fluid" alt="collection-5">
                                            </a>
                                            <a href="<?php echo e(route('collection2')); ?>" class="d-block d-xl-none banner-img br-hidden">
                                            ...
                                            <div class="cat-content pst-15">
                                                ...
                                                <div class="d-xl-none mst-7">
                                                    <a href="<?php echo e(route('collection2')); ?>" class="link-btn">Shop now</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="swiper-slide h-auto d-flex" data-animate="animate__fadeIn">
                                        <div class="cat-block banner-hover w-100 ptb-15 plr-15 body-bg border-radius">
                                            <a href="<?php echo e(route('kidscollection3')); ?>" class="d-none d-xl-block position-relative banner-img br-hidden">
                                                <span class="btn-style tertiary-btn banner-btn position-absolute top-50 start-50 translate-middle z-1 text-nowrap">Shop now</span>
                                                   <img src="category_images/1764658050_bag image.webp" class="w-100 img-fluid" alt="collection-5">
                                            </a>
                                            <a href="<?php echo e(route('collection3')); ?>" class="d-block d-xl-none banner-img br-hidden">
                                            ...
                                            <div class="cat-content pst-15">
                                                ...
                                                <div class="d-xl-none mst-7">
                                                    <a href="<?php echo e(route('collection3')); ?>" class="link-btn">Shop now</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<?php echo $__env->make('layouts.frontend-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laravel_git\ecommerce-web\resources\views/kidsmaincategory.blade.php ENDPATH**/ ?>