<?php $__env->startSection('title', 'jeans&jeggings collection'); ?>
...
<?php $__env->stopPush(); ?>
     ...
     style="background-image: url('<?php echo e(asset('category_banners/1764653883_women jeans&jeggings.webp')); ?>');
    ...
    <div class="container">
        ...
        <h2 class="extra-color font-24 font-xl-32 mst-5 mst-xl-9">Jeans & Jeggings Collection</h2>
    </div>
</div>
...
<?php echo $__env->make('layouts.frontend-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laravel_git\ecommerce-web\resources\views/womenjeanscollection.blade.php ENDPATH**/ ?>