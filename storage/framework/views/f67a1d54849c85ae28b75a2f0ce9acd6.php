...
<body>
    <div id="ebazar-layout" class="theme-blue">
        ...
        <!-- sidebar -->
        <?php echo $__env->make('partials.couriersidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <!-- sidebar -->
        ...
        <div class="main px-lg-4 px-md-4">
            ...
            <!-- Body: Header -->
            <?php echo $__env->make('partials.courierheader', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <!-- Body: Header -->
...
<?php /**PATH E:\laravel_git\ecommerce-web\resources\views/layouts/courier-layout.blade.php ENDPATH**/ ?>