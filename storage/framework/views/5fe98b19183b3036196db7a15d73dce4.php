...
<?php $__env->startSection('title', 'Courier Boy Login'); ?>
...
<div class="courier-animation">
    ...
    <img src="<?php echo e(asset('category_images/c-boy-img.png')); ?>" class="courier-boy">
...
<div class="extra-links"> <p>New courierboy? <a href="<?php echo e(route('courierboy.signup')); ?>">Create account</a></p> </div>
...
fetch("<?php echo e(route('courier.login.submit')); ?>",{
    method:'POST',
    headers:{
...
<?php echo $__env->make('layouts.frontend-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laravel_git\ecommerce-web\resources\views/courierboy/loginform.blade.php ENDPATH**/ ?>