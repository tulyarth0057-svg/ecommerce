<?php $__env->startSection('title', 'kids asccessories collection'); ?>
...
<?php $__env->startSection('content'); ?>
     ...
     style="background-image: url('<?php echo e(asset('category_banners/1764658050_kids asscoriesbanner.webp')); ?>');
    ...
    <div class="container">
        ...
        <h2 class="extra-color font-24 font-xl-32 mst-5 mst-xl-9">Kids Accessories Collection</h2>
    </div>
</div>
...
<?php echo $__env->make('layouts.frontend-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laravel_git\ecommerce-web\resources\views/kidsAccessoriescollection3.blade.php ENDPATH**/ ?>