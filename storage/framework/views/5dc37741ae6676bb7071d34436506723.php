                ...
                <ul class="menu-list flex-grow-1 mt-3">
                    ...
                    <li class="collapsed">
                        <a class="m-link" data-bs-toggle="collapse" data-bs-target="#menu-product" href="#">
                            ...
                            <ul class="sub-menu collapse" id="menu-product">
                                  <li><a class="ms-link" href="<?php echo e(route('product.create')); ?>">Add Product</a></li>
                    ...
                    <li class="collapsed">
                        ...
                        <ul class="sub-menu collapse" id="menu-order">
                            <li><a class="ms-link" href="<?php echo e(route('order.list')); ?>">Orders List</a></li>
                    ...
                    <li class="collapsed">
                        ...
                        <ul class="sub-menu collapse" id="customers-info">
                            <li><a class="ms-link" href="<?php echo e(route('contact.list')); ?>">Customers List</a></li>
