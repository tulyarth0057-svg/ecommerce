...
<!-- Mirrored from spacingtech.com/html/erona/template/cart-page.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 29 Oct 2025 07:45:21 GMT -->
    ...
    <body>
        ...
        <div class="breadcrumb-area ptb-30 bg-img text-center" data-bgimg="assets/image/other/breadcrumb-bgimg.jpg">
            <div class="container">
                ...
                <h2 class="extra-color font-24 font-xl-32 mst-5 mst-xl-9">Cart</h2>
            </div>
        </div>
        <!-- breadcrumb-area end -->
        <!-- main start -->
                                                    ...
                                                    <div class="col-12 col-md-5">
                                                        ...
                                                        <div class="cart-item-content d-flex flex-wrap">
                                                            ...
                                                            <div class="cart-item-info width-calc-88 psl-15">
                                                                ...
                                                                <span class="d-block heading-color mst-7 heading-weight">$79.00</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-6 col-sm-4 col-md-3">
                                                        ...
                                                        <div class="js-qty-wrapper">
                                                            <div class="js-qty-wrap d-flex body-bg border-full br-hidden">
                                                                <button type="button" class="js-qty-adjust js-qty-adjust-minus body-color icon-16 ber" aria-label="Remove item"><i class="ri-subtract-line d-block lh-1"></i></button>
                                                                <input type="number" name="pleated-skater-skirt-xs-aliceblue" class="js-qty-num p-0 text-center border-0" value="1" min="1">
                                                                <button type="button" class="js-qty-adjust js-qty-adjust-plus body-color icon-16 bsl" aria-label="Add item"><i class="ri-add-line d-block lh-1"></i></button>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-12 col-md-5">
                                                        ...
                                                        <div class="cart-item-content d-flex flex-wrap">
                                                            ...
                                                            <div class="cart-item-info width-calc-88 psl-15">
                                                                ...
                                                                <span class="d-block heading-color mst-7 heading-weight">$49.00</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-6 col-sm-4 col-md-3">
                                                    ...
                                                    <div class="col-12 col-md-5">
                                                        ...
                                                        <div class="cart-item-content d-flex flex-wrap">
                                                            ...
                                                            <div class="cart-item-info width-calc-88 psl-15">
                                                                ...
                                                                <span class="d-block heading-color mst-7 heading-weight">$69.00</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-6 col-sm-4 col-md-3">
...
<?php /**PATH E:\laravel_git\ecommerce-web\resources\views/cart-page.blade.php ENDPATH**/ ?>