<?php $__env->startSection('title', 'pants & jeans collection'); ?>
...
<?php $__env->startSection('content'); ?>
     ...
     style="background-image: url('<?php echo e(asset('category_banners/1764587504_fomalpants and jeansbannerformen.webp')); ?>');
    ...
    <div class="container">
        ...
        <h2 class="extra-color font-24 font-xl-32 mst-5 mst-xl-9">Jeans Collection</h2>
    </div>
</div>
                                            ...
                                            <div class="row row-mtm15 align-items-md-center">
                                                <div class="col-12 col-sm-6 col-md-7 col-lg-8">
                                                    <div class="shop-filter-view ul-mt15 align-items-center">
                                                        ...
                                                        <div class="shop-show-product">Showing 2 of 12 products</div>
...
<?php echo $__env->make('layouts.frontend-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laravel_git\ecommerce-web\resources\views/menformalpantcollection.blade.php ENDPATH**/ ?>