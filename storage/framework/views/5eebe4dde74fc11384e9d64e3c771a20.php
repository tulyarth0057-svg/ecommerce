...
<div class="container my-5">
    ...
    <div class="col-10 main-img">
        ...
        <div class="col-md-6">
            ...
            <!-- Price -->
            <div class="mb-3">
                <span class="price">₹<?php echo e(number_format($product->p_price, 2)); ?>

                <span class="old-price text-decoration-line-through ms-3 fw-bold-none fs-5">₹<?php echo e(number_format($product->p_old_price, 2)); ?></span>
            ...
            <div class="mb-3">
                <label class="fw-semibold d-block mb-2 d-flex align-items-center gap-2 ">Color</label>
                 ...
                 <div class="d-flex align-items-center gap-2 mb-2">
                    ...
                    <span class="" ><?php echo e($color->color_name); ?></span>
                </div>
    ...
    <div class="accordion-item">
        ...
        <div id="details"
            ...
            <div class="accordion-body">
                <?php echo e($product->p_short_description); ?>

            </div>

              <div class="accordion-body">
                <?php echo e($product->p_long_description); ?>
