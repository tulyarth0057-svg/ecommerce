<?php $__env->startSection('title', ' All Women-collection'); ?>
...
<?php $__env->startSection('content'); ?>
     ...
     style="background-image: url('<?php echo e(asset('category_images/womenmaincategorybanner.jpg')); ?>');
                                        ...
                                        <div class="cat-block banner-hover w-100 ptb-15 plr-15 body-bg border-radius">
                                            ...
                                            <div class="cat-content pst-15">
                                                ...
                                                <div class="d-xl-none mst-7">
                                                    <a href="<?php echo e(route('womenkurtiscollection')); ?>" class="link-btn">Shop now</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<?php echo $__env->make('layouts.frontend-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laravel_git\ecommerce-web\resources\views/Womencategorycollection.blade.php ENDPATH**/ ?>