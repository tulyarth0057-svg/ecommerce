<?php $__env->startSection('title', ' All Men-collection'); ?>
...
<?php $__env->startSection('content'); ?>
     ...
     style="background-image: url('<?php echo e(asset('category_banners/mainbanner.jpg')); ?>');
                            ...
                            <div class="cat-slider swiper" id="cat-slider">
                                <div class="swiper-wrapper">
                                   <div class="swiper-slide h-auto d-flex" data-animate="animate__fadeIn">
                                    ...
                                    <div class="swiper-slide h-auto d-flex" data-animate="animate__fadeIn">
                                        <div class="cat-block banner-hover w-100 ptb-15 plr-15 body-bg border-radius">
                                            <a href="<?php echo e(route('menshoescollection')); ?>" class="d-none d-xl-block position-relative banner-img br-hidden">
                                                <span class="btn-style tertiary-btn banner-btn position-absolute top-50 start-50 translate-middle z-1 text-nowrap">Shop now</span>
                                                  <img src="category_images/1764587870_menshoesimg.webp"  class="w-100 img-fluid" alt="collection-3">
                                            </a>
                                            <a href="<?php echo e(route('menshoescollection')); ?>" class="d-block d-xl-none banner-img br-hidden">
                                                <img src="category_images/1764587870_menshoesimg.webp" class="w-100 img-fluid" alt="collection-3">
                                            </a>
                                            <div class="cat-content pst-15">
                                                <div class="ul-mtm15 justify-content-between heading-weight">
                                                ...
                                                <div class="d-xl-none mst-7">
                                                    <a href="<?php echo e(route('menshoescollection')); ?>" class="link-btn">Shop now</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<?php echo $__env->make('layouts.frontend-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laravel_git\ecommerce-web\resources\views/Mencategorycollection.blade.php ENDPATH**/ ?>