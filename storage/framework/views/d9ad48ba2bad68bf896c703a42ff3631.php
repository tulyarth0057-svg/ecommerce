...
<?php $__env->startSection('title', 'Courier Profile'); ?>
...
<div class="profile-page-wrap">
    <div class="profile-container">
        ...
        <div class="profile-card">
            ...
            <h2 class="profile-name"><?php echo e($courier->name); ?></h2>
            <p class="profile-email-text"><?php echo e($courier->email); ?></p>

            <!-- Stats -->
            <div class="stats-row">
                <div class="stat-box">
                    <div class="stat-number"><?php echo e($courier->total_deliveries ?? '0'); ?></div>
                    <div class="stat-label">Deliveries</div>
                </div>
                <div class="stat-box">
                    <div class="stat-number"><?php echo e($courier->rating ?? '—'); ?></div>
                    <div class="stat-label">Rating</div>
                </div>
                <div class="stat-box">
                    <div class="stat-number"><?php echo e($courier->total_earnings ?? '₹0'); ?></div>
            ...
            <div class="details-grid">
                ...
                <div class="detail-item">
                    ...
                    <div>
                        ...
                        <div class="detail-value"><?php echo e($courier->mobile); ?></div>
                    </div>
                </div>
                ...
                <div class="detail-item">
                    ...
                    <div>
                        ...
                        <div class="detail-value"><?php echo e($courier->email); ?></div>
                    </div>
                </div>
            ...
            <div class="details-grid">
                ...
                <div class="detail-item">
                    ...
                    <div>
                        ...
                        <div class="detail-value"><?php echo e($courier->account_holder_name); ?></div>
                    </div>
                </div>
                ...
                <div class="detail-item">
                    ...
                    <div>
                        ...
                        <div class="detail-value">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($courier->bank_account): ?>
                                 •••• •••• <?php echo e(substr($courier->bank_account, -4)); ?>
                ...
                <div class="detail-item" style="grid-column: span 2;">
                    ...
                    <div>
                        ...
                        <div class="detail-value"><?php echo e($courier->ifsc_code); ?></div>
                    </div>
                </div>
            ...
            <div class="edit-btn-wrap">
                <a href="<?php echo e(route('courier.profile.update')); ?>" class="edit-btn">
...
<?php echo $__env->make('layouts.courier-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laravel_git\ecommerce-web\resources\views/courier/courierboy-profile.blade.php ENDPATH**/ ?>