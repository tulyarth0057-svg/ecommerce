(function($) {
    ...
    var ST = {
                ...
                return this.each(function() {
                    ...
                    var createSticky = function() {
                        ...
                        function updatePaddingTop() {
                            $(".slider-content .slider-container, .breadcrumb-area").css({"padding-top": targetHeight});
                        }
                        updatePaddingTop();
                        function stickyHeader() {
                            ...
                            if(isResizing) {
                                ...
                                if($window.scrollTop() >= 20) {
                                    HeaderTarget.addClass("primary-bg");
                                    HeaderTarget.find(showHeaderFirst).addClass("primary-bg header-border");
                                } else {
                                    HeaderTarget.removeClass("primary-bg");
                                    HeaderTarget.find(showHeaderFirst).removeClass("primary-bg header-border");
                                }
                                if($window.scrollTop() >= scrollHeader) {
                                    HeaderTarget.addClass("sticky");
                                    const cssValue = {"transform": "translateY(-" + targetHeight + "px)"};
                                    if(!isRefreshed) {
                                        cssValue.transition = "transform 0.3s ease,background-color 0.3s ease";
                                    }
                                    HeaderTarget.css(cssValue);
                                    isRefreshed = false;
                                } else {
                                    HeaderTarget.removeClass("sticky");
                                    HeaderTarget.css({"transform": "translateY(0px)","transition": "transform 0.3s ease,background-color 0.3s ease"});
                                }
                                // Scroll direction check
                                if($window.scrollTop() > lastScroll) {
                                    $(".sticky").removeClass("header-sticky"); // Scrolling down
                                    HeaderTarget.find(showHeaderFirst).css({"transform": "translateY(0px)","transition": "transform 0.3s ease,background-color 0.3s ease"});
                                ...
                                if(lastScroll <= scrollHeader) {
                                    ...
                                    HeaderTarget.find(showHeaderFirst).removeClass("primary-bg");
                ...
                $document.on("click", ".review-submit", function() {
                    ...
                    var newReviewDetail = `
                        <div class="product-review-detail">
                            ...
                            <div class="product-reviewer-date mst-11">Reviwed on ${currentDate}</div>
        ...
        footerJs: function() {
            ...
            // footer-service js
            var swiper = new Swiper('.swiper#service-slider', {
                loop: false,
                rewind: true,
                slidesPerView: 4,
                spaceBetween: 30,
    ...
    ST.trendProduct = {
        init: function() {
            ...
            var swiper = new Swiper('.swiper#trend-product-slider', {
                ...
                scrollbar: {
                    el: '.swiper-scrollbar-trend-product',
                    draggable: true,
                },
                autoplay: {
                    delay: 5000,
