(function($) {
    ...
    var ST = {
        ...
        headerNotification: function() {
            var swiper = new Swiper('.swiper#notification-slider', {
                loop: false,
                rewind: true,
                slidesPerView: 1,
                spaceBetween: 0,
                ...
                navigation: {
                    prevEl: '.swiper-prev-notification',
                    nextEl: '.swiper-next-notification'
                },
                autoplay: {
                    delay: 5000,
    ...
    ST.bigText = {
        init: function() {
            function bigTextOverlay() {
                var $bigTextOverlay = $(".big-text-overlay");
                $bigTextOverlay.each(function() {
                    var $bigTextHeight = $(this).outerHeight();
                    $(this).css("margin-bottom", `-${$bigTextHeight / 2}px`);
                });
            }
            bigTextOverlay();
            $window.on("resize", bigTextOverlay);
        }
    };
    ...
    ST.bestProduct = {
        init: function() {
            ...
            adjustArrowPosition();
            var swiper = new Swiper('.swiper#best-product-slider', {
                loop: false,
                rewind: true,
                slidesPerView: 3,
                spaceBetween: 30,
                ...
                watchSlidesProgress: true,
                navigation: {
                    prevEl: '.swiper-prev-best-product',
                    nextEl: '.swiper-next-best-product'
                },
                pagination: {
