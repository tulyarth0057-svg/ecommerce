(function($) {
    ...
    ST.productList = {
        ...
        productList4: function() {
            var swiper = new Swiper('.swiper#product-list4-slider', {
                loop: false,
                rewind: true,
                slidesPerView: 1,
                grid: {
                ...
                watchSlidesProgress: true,
                navigation: {
                    prevEl: '.swiper-prev-product-list4',
                    nextEl: '.swiper-next-product-list4'
                },
                pagination: {
                    el: ".swiper-pagination-product-list4",
                    clickable: true
                },
                autoplay: {
                    delay: 5000,
