...
@section('title', ' All kids-collection')
...
@section('content')
     ...
     style="background-image: url('{{ asset('category_banners/kidsmainbanner.jpg') }}');
                                ...
                                <div class="swiper-wrapper">
                                   <div class="swiper-slide h-auto d-flex" data-animate="animate__fadeIn">
                                        <div class="cat-block banner-hover w-100 ptb-15 plr-15 body-bg border-radius">
                                            ...
                                            <a href="{{ route('kidstoyscollection1')}}" class="d-block d-xl-none banner-img br-hidden">
                                            ...
                                            <div class="cat-content pst-15">
                                                ...
                                                <div class="d-xl-none mst-7">
                                                    <a href="{{ route('kidstoyscollection1') }}" class="link-btn">Shop now</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="swiper-slide h-auto d-flex" data-animate="animate__fadeIn">
                                        <div class="cat-block banner-hover w-100 ptb-15 plr-15 body-bg border-radius">
                                            <a href="{{ route('kidsclothescollection2') }}" class="d-none d-xl-block position-relative banner-img br-hidden">
                                                <span class="btn-style tertiary-btn banner-btn position-absolute top-50 start-50 translate-middle z-1 text-nowrap">Shop now</span>
                                                  <img src="category_images/1764657243_kurta-pajama-pink-1.webp" class="w-100 img-fluid" alt="collection-5">
                                            </a>
                                            <a href="{{ route('kidsclothescollection2') }}" class="d-block d-xl-none banner-img br-hidden">
                                            ...
                                            <div class="cat-content pst-15">
                                                ...
                                                <div class="d-xl-none mst-7">
                                                    <a href="{{ route('kidsclothescollection2') }}" class="link-btn">Shop now</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="swiper-slide h-auto d-flex" data-animate="animate__fadeIn">
                                        <div class="cat-block banner-hover w-100 ptb-15 plr-15 body-bg border-radius">
                                            <a href="{{ route('kidsAccessoriescollection3') }}" class="d-none d-xl-block position-relative banner-img br-hidden">
                                                <span class="btn-style tertiary-btn banner-btn position-absolute top-50 start-50 translate-middle z-1 text-nowrap">Shop now</span>
                                                   <img src="category_images/1764658050_bag image.webp" class="w-100 img-fluid" alt="collection-5">
                                            </a>
                                            <a href="{{ route('kidsAccessoriescollection3') }}" class="d-block d-xl-none banner-img br-hidden">
                                            ...
                                            <div class="cat-content pst-15">
                                                ...
                                                <div class="d-xl-none mst-7">
                                                    <a href="{{ route('kidsAccessoriescollection3') }}" class="link-btn">Shop now</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
