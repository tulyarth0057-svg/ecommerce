...
@section('title', 'Update-courierboy-Profile')
    ...
    <div class="up-container">
        ...
        <div class="up-card">
            ...
            <div class="up-avatar-section">
                <label for="profile_photo_input" class="up-avatar-ring">
                    <img id="avatarPreview"
                         src="{{ $courier->profile_photo ? asset('storage/' . $courier->profile_photo) : asset('assetsofdash/images/profile_av.svg') }}"
                         alt="Profile Photo">
            ...
            <form id="profileForm" class="up-form-body" novalidate>
                ...
                <div class="up-grid">
                    ...
                    <div class="up-group">
                        ...
                        <div class="up-input-wrap">
                            ...
                            <input type="text" id="name" name="name" value="{{ old('name', $courier->name) }}" class="up-input" placeholder="John Doe">
                        </div>
                    ...
                    <div class="up-group">
                        ...
                        <div class="up-input-wrap">
                            ...
                            <input type="email" id="email" name="email" value="{{ old('email', $courier->email) }}" class="up-input" placeholder="you@email.com">
                        </div>
                    ...
                    <div class="up-group" style="grid-column: span 2;">
                        ...
                        <div class="up-input-wrap">
                            ...
                            <input type="text" id="mobile" name="mobile" value="{{ old('mobile', $courier->mobile) }}" class="up-input" placeholder="+91 XXXXXXXXXX">
                        </div>
                    ...
                    <!-- aadhar and vehicle photo upload -->
                ...
                {{-- aadhar and vehicle photo upload change here---> --}}

                <!-- Veichle RC Photo -->
<div class="up-avatar-section">
    <label for="rc_photo_input" class="up-avatar-ring">
       <img id="rcPreview"
             src="{{ asset('storage/' . $courier->vehicle_rc) }}"
             alt="Aadhar Photo">
       
        <div class="up-avatar-overlay">
            <svg> <!-- same overlay icon as profile photo --> </svg>
        </div>
    </label>
    <p class="up-avatar-label">Click to change · <span>Change RC</span></p>
    <input type="file" id="rc_photo_input" name="rc_photo" accept="image/*" style="display:none;">
</div>

<!-- Aadhar Photo -->
<div class="up-avatar-section">
    <label for="aadhar_photo_input" class="up-avatar-ring">
        <img  id="aadharPreview"
             src="{{ asset('storage/' . $courier->id_proof) }}"
             alt="Aadhar Photo">
        <div class="up-avatar-overlay">
            <svg> <!-- same overlay icon as profile photo --> </svg>
        </div>
    </label>
    <p class="up-avatar-label">Click to change · <span>Change Aadhar</span></p>
    <input type="file" id="aadhar_photo_input" name="aadhar_photo" accept="image/*" style="display:none;">
</div>
                ...
                <div class="up-grid">
                    ...
                    <div class="up-group">
                        ...
                        <div class="up-input-wrap">
                            ...
                            <input type="text" id="account_holder_name" name="account_holder_name" value="{{ old('account_holder_name', $courier->account_holder_name) }}" class="up-input" placeholder="Full legal name">
                        </div>
                    ...
                    <div class="up-group">
                        ...
                        <div class="up-input-wrap">
                            ...
                            <input type="text" id="bank_account" name="bank_account" value="{{ old('bank_account', $courier->bank_account) }}" class="up-input" placeholder="Account number">
                        </div>
                    ...
                    <div class="up-group" style="grid-column: span 2;">
                        ...
                        <div class="up-input-wrap">
                            ...
                            <input type="text" id="ifsc_code" name="ifsc_code" value="{{ old('ifsc_code', $courier->ifsc_code) }}" class="up-input" placeholder="e.g. UTIB0000001">
                        </div>
...
(function () {
    ...
    const adharInput = document.getElementById('aadhar_photo_input');
    const rcInput    = document.getElementById('rc_photo_input');
    ...
    function checkChanges() {
        ...
        for (let id of fields) {
            const el = document.getElementById(id);
            if (el && el.value.trim() !== originalValues[id]) {
                setButtonDisabled(false);
                return;
            }
        }
    ...
    /* Profile preview */
    photoInput.addEventListener('change', () => previewImage(photoInput, avatar));

    /* RC preview */
    rcInput.addEventListener('change', () => previewImage(rcInput, rcPreview));

    /* Aadhar preview */
    adharInput.addEventListener('change', () => previewImage(adharInput, aadharPreview));
    ...
    form.addEventListener('submit', function (e) {
        ...
        if (rcInput.files[0])    data.set('rc_photo', rcInput.files[0]);
        if (adharInput.files[0]) data.set('aadhar_photo', adharInput.files[0]);

        setLoading(true);

        fetch("{{ route('courierboy.update') }}", {
            method: 'POST',
            headers: {
