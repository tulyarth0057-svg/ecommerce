        ...
        <ul class="menu-list flex-grow-1 mt-3">
            ...
            <li class="collapsed">
                ...
                <ul class="sub-menu collapse" id="my-deliveries">
                    <li><a class="ms-link" href="{{ route('courier.courier.assigned') }}">Assigned Orders list</a></li>
                    <li><a class="ms-link" href="{{ route('courier.courier.pending') }}">Pending Deliveries list</a></li>
            ...
            <li class="collapsed">
                ...
                <ul class="sub-menu collapse" id="update-status">
                    <li><a class="ms-link" href="{{ route('courier.pickedup.list') }}">Picked Up list</a></li>
                     <li><a class="ms-link" href="{{ route('courier.courier.completed') }}">Completed Deliveries list</a></li>
                </ul>
            </li>
            ...
            <li class="collapsed">
                ...
                <ul class="sub-menu collapse" id="profile">
                    <li><a class="ms-link" href="{{ route('courier.courierboy.profile') }}">View Profile</a></li>
