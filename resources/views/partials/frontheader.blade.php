    ...
    <form id="loginForm">
      ...
      <div class="modal-content p-3">
        <div class="d-flex justify-content-center">
          <img src="{{ asset('assetsofdash/images/Red and Black Modern Creative Agency Logo-old.png') }}" class="rounded-1" width="200" height="80">
        </div>
        ...
        $.ajax({
            ...
            success: function(res){
                ...
                .then(()=>{
                    ...
                    if(res.role==='admin') window.location.href="{{ route('admin.dashboard') }}";
