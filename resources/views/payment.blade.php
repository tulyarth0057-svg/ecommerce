...
<!-- Mirrored from spacingtech.com/html/erona/template/payment-policy.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 29 Oct 2025 07:45:34 GMT -->
                    ...
                    <div class="row row-mtm align-items-md-start">
                            ...
                            <div class="per-xxl-10">
                                <div class="row row-mtm">
                                    <div class="col-12">
                                        ...
                                        <div class="ul-mtm-15">
                                            <span data-animate="animate__fadeIn"><i class="ri-phone-line icon-16 mer-4"></i><a href="tel:+919876543210" class="body-primary-color">+91 98765-43210</a></span>
                                            <span data-animate="animate__fadeIn"><i class="ri-mail-line icon-16 mer-4"></i><a href="mailto:info@demowebsite.com" class="body-primary-color">info@demowebsite.com</a></span>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <h6 class="other-tab-title font-20 meb-18" data-animate="animate__fadeIn"><span>Policies</span></h6>
                                        <div class="ul-mtm-15">
                                            <span data-animate="animate__fadeIn"><a href="cancellation.html" class="body-primary-color">Cancellation</a></span>
                                            <span data-animate="animate__fadeIn"><a href="cookie.html" class="body-primary-color">Cookie page</a></span>
                                            <span data-animate="animate__fadeIn"><a href="faqs.html" class="body-primary-color">Faq's page</a></span>
                                            <span data-animate="animate__fadeIn"><a href="legal.html" class="body-primary-color">Legal page</a></span>
                                            <span data-animate="animate__fadeIn"><a href="javascript:void(0)" class="primary-color">Payment policy</a></span>
                                            <span data-animate="animate__fadeIn"><a href="privacy-policy.html" class="body-primary-color">Privacy policy</a></span>
                                            <span data-animate="animate__fadeIn"><a href="return-policy.html" class="body-primary-color">Return policy</a></span>
                                            <span data-animate="animate__fadeIn"><a href="shipping-policy.html" class="body-primary-color">Shipping policy</a></span>
                                            <span data-animate="animate__fadeIn"><a href="terms-condition.html" class="body-primary-color">Terms & conditions</a></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-12 col-md-8 col-lg-9 p-md-sticky top-0">
                            <div class="question-index">
                                <h6 class="font-18" data-animate="animate__fadeIn">Secure transaction rules and payment process</h6>
                                <p class="mst-18" data-animate="animate__fadeIn">Discover the steps to ensure safe and seamless payments on our platform. Learn about payment methods, security measures, and how to protect your financial data.</p>
                                ...
                                <h6 class="font-18 mst-18" data-animate="animate__fadeIn">Top payment options</h6>
                                <p class="p-bullets mst-18 animate__fadeIn animate__animated" data-animate="animate__fadeIn"><span class="heading-color heading-weight mer-4">Visa transactions:</span>Secure Visa card payments processed quickly and easily.</p>
                                <p class="p-bullets mst-1 animate__fadeIn animate__animated" data-animate="animate__fadeIn"><span class="heading-color heading-weight mer-4">Maestro transactions:</span>Payment transactions handled via maestro card services.</p>
                                <p class="p-bullets mst-1 animate__fadeIn animate__animated" data-animate="animate__fadeIn"><span class="heading-color heading-weight mer-4">Paypal transactions:</span>Handling payments through paypal for secure transactions.</p>
                                <p class="p-bullets mst-1 animate__fadeIn animate__animated" data-animate="animate__fadeIn"><span class="heading-color heading-weight mer-4">Discover payments:</span>Processing secure payments with discover card services.</p>
                                <p class="p-bullets mst-1 animate__fadeIn animate__animated" data-animate="animate__fadeIn"><span class="heading-color heading-weight mer-4">Google payment:</span>Make fast, secure payments using google wallet services.</p>
                                <p class="p-bullets mst-1 animate__fadeIn animate__animated" data-animate="animate__fadeIn"><span class="heading-color heading-weight mer-4">Amex card:</span>Make secure payments using your american express card.</p>
                                <a href="contact-us.html" class="btn-style secondary-btn mst-23" data-animate="animate__fadeIn">Know more</a>
                                <div class="pst-30 mst-30 bst" data-animate="animate__fadeIn"></div>
                                <h6 class="question-sub-index font-18" data-animate="animate__fadeIn">What payment methods can i use?</h6>
                                <p class="p-bullets mst-18">We accept a variety of payment methods including major credit and debit cards, digital wallets like paypal and apple pay, and bank transfers. Ensure your selected method is supported to avoid transaction issues.</p>
                                <p class="p-bullets mst-6">For international payments, check our supported currencies list to make sure your payment method is compatible.</p>
                                <h6 class="question-sub-index font-18 mst-18">How are charges applied during checkout?</h6>
                                <p class="p-bullets mst-18">Charges include the total cost of items, applicable taxes based on your location, and any additional fees related to your payment method. All charges will be clearly displayed before you confirm your purchase to ensure transparency and avoid unexpected costs.</p>
                                <h6 class="question-sub-index font-18 mst-18">Can i change my payment details after purchase?</h6>
                                <p class="p-bullets mst-18">Once a transaction is processed, payment details cannot be altered. However, if you have a subscription or recurring payment plan, you can update your payment details before the next billing cycle begins to ensure uninterrupted service.</p>
                                <h6 class="question-sub-index font-18 mst-18">What should i do if my payment fails?</h6>
                                <p class="p-bullets mst-18">If your payment fails, you'll receive an error notification with instructions to retry. Common issues include insufficient funds or incorrect payment details. Ensure your payment method has sufficient balance and is entered correctly.</p>
                                <p class="p-bullets mst-6">If the problem persists, contact our support team for assistance to resolve any issues promptly.</p>
                                <h6 class="question-sub-index font-18 mst-18">Are there additional fees for certain payment methods?</h6>
                                <p class="p-bullets mst-18">Some payment methods may incur extra fees, such as transaction fees for international payments or processing fees for specific digital wallets. These fees will be detailed during the checkout process so you can choose the most cost-effective payment option.</p>
                                <h6 class="question-sub-index font-18 mst-18">How can i get a refund if needed?</h6>
                                <p class="p-bullets mst-18">To request a refund, please contact our customer support team with your order details. Refunds are processed according to our return policy, which includes time limits and conditions for eligibility.</p>
                                <p class="p-bullets mst-6">Refunds will be issued to the original payment method used at checkout and may take a few business days to reflect in your account.</p>
                                <h6 class="question-sub-index font-18 mst-18">Are my payment details secure?</h6>
                                <p class="p-bullets mst-18">Yes, we use advanced encryption and security protocols to protect your payment information during transactions. Our payment system complies with industry standards to ensure your data is kept safe from unauthorized access.</p>
                                <p class="p-bullets mst-6">We also regularly update our security measures to safeguard against emerging threats and ensure your financial information remains confidential.</p>
                                <h6 class="question-sub-index font-18 mst-18">Can i save my payment details for future purchases?</h6>
                                <p class="p-bullets mst-18">We offer the option to save payment details for convenience on future purchases, but this feature is optional. You can enable or disable it in your account settings. For enhanced security, saved payment methods are stored with encryption and are accessible only through secure login.</p>
                                <h6 class="question-sub-index font-18 mst-18">What should i do if i see an unauthorized charge?</h6>
                                <p class="p-bullets mst-18">If you notice an unauthorized charge, contact our customer service immediately to report the issue. We will investigate the charge and assist in resolving any discrepancies. In the meantime, review your payment method statements and consider reaching out to your bank or card issuer to prevent further unauthorized transactions.</p>
                                <h6 class="question-sub-index font-18 mst-18">Do you charge any late fees for overdue payments?</h6>
                                <p class="p-bullets mst-18">Late fees may apply if payments are not received by the due date. These fees are outlined in your purchase agreement and will be added to your total outstanding balance. We send reminders before the due date to help you avoid late fees and ensure timely payment processing.</p>
                            </div>
                        </div>
                    </div>
                </div>
