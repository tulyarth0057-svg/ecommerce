        ...
        <div class="address-content">
            <div class="address-item">
                ...
                <div class="address-text">
                    <div class="name">{{ $order->o_name }}</div>
                </div>
            </div>
            <div class="address-item">
                <i class="ri-mail-line"></i>
                <div class="address-text">
                    <div class="detail">{{ $order->o_email }}</div>
                </div>
            </div>
            <div class="address-item">
                <i class="ri-phone-line"></i>
                <div class="address-text">
                    <div class="detail">{{ $order->o_phone }}</div>
                </div>
            </div>
            <div class="address-item">
            ...
            <div class="card-body">
               ...
               <div class="price-summary mt-4">
                        ...
                        <div class="price-row">
                            <span>Shipping</span>
                            <span>
                                ₹{{ number_format($order->o_shipping_cost / max(count($orderItems),1), 2) }}
                            </span>
                        </div>
                    ...
                    <button class="payment-status-btn 
                        {{ strtolower($order->o_payment_status) == 'paid' ? 'payment-paid' : 'payment-pending' }}">
