                                ...
                                <div class="wish-textview ul-mtm30">
                                    ...
                                    <div class="wish-text">
                                        <div class="wish-text-content ul-mtm-15">
                                            ...
                                            <span><a href="login.html" class="body-primary-color text-decoration-underline">Login</a> or <a href="register.html" class="body-primary-color text-decoration-underline">Create account</a> to make sure lists will be saved.</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
