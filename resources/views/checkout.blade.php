...
<!-- Mirrored from spacingtech.com/html/erona/template/checkout.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 29 Oct 2025 07:45:21 GMT -->
                ...
                <form method="post" action="javascript:void(0)">
                    <div class="container">
                        <div class="row row-mtm align-items-lg-start">
                                                ...
                                                <div class="ul-mt15">
                                                    <div class="checkitem-img width-88">
                                                        <div class="position-relative">
                                                            ...
                                                            <span class="checkitem-qty extra-color font-11 position-absolute d-flex align-items-center justify-content-center secondary-bg rounded-circle lh-1">1</span>
                                                        </div>
                                                    </div>
                            ...
                            <div class="col-12 col-lg-7 col-xl-8 p-lg-sticky top-0">
                                <div class="checkout-billview">
                                    <div class="checkout-box ptb-30 plr-15 plr-md-30 meb-30 extra-bg border-radius" data-animate="animate__fadeIn">
                                    ...
                                    <div class="row row-mtm align-items-xl-start">
                                        <div class="col-12 col-xl-6 p-xl-sticky top-0">
                                            <div class="ptb-30 plr-15 plr-md-30 body-bg border-full border-radius" data-animate="animate__fadeIn">
                                                            ...
                                                            <div class="acc-detail-info d-none">
                                                                <div class="row row-mtm">
                                                                    <div class="col-12 col-sm-6 col-xl-12">
                                                                        ...
                                                                        <span class="d-inline-block heading-color heading-weight meb-22">Shipping address</span>
                                                                        <div class="st-label d-flex mst-4 meb-11">
                                                                            <span class="d-inline-block st-small-label bg-dark">Home</span>
                                                                        </div>
                                                                        <div class="ul-mtm-15">
                                                                            <span>Demo name</span>
                                                                            <span>Spacingtech infotech</span>
                                                                            <a href="mailto:demo@demo.com" class="body-primary-color">demo@demo.com</a>
                                                                            <a href="tel:(+00)123456789" class="body-primary-color">(+00)-123456789</a>
                                                                    ...
                                                                    <div class="col-12 col-sm-6 col-xl-12">
                                                                        ...
                                                                        <span class="d-inline-block heading-color heading-weight meb-22">Billing address</span>
                                                                        <div class="st-label d-flex mst-4 meb-11">
                                                                            <span class="d-inline-block st-small-label bg-dark">Home</span>
                                                                        </div>
                                                                        <div class="ul-mtm-15">
                                                            ...
                                                            <div class="acc-detail-form">
                                                                <div class="acc-detail-field">
                                                                    <div class="row row-mtm">
                                                                            ...
                                                                            <div class="acc-detail-hide">
                                                                                <div class="row field-row">
                                                                                    <div class="col-12 col-md-6 col-xl-12 field-col">
                                                                                        ...
                                                                                        <input type="text" id="name" name="name" class="w-100" value="Demo name" placeholder="Your name" autocomplete="name">
                                                                                    </div>
                                                                                    <div class="col-12 col-md-6 col-xl-12 field-col">
                                                                                        <label for="organization" class="field-label">Company (optional)</label>
                                                                                        <input type="text" id="organization" name="organization" class="w-100" value="Spacingtech infotech" placeholder="Company name" autocomplete="organization">
                                                                                    </div>
                                                                                    <div class="col-12 col-md-6 col-xl-12 field-col">
                                                                                        <label for="email" class="field-label">Email</label>
                                                                                        <input type="email" id="email" name="email" class="w-100" value="demo@demo.com" placeholder="Email address" autocomplete="email">
                                                                                    </div>
                                                                                    <div class="col-12 col-md-6 col-xl-12 field-col">
                                                                                        <label for="phone" class="field-label">Phone</label>
                                                                                        <input type="text" id="phone" name="phone" class="w-100" value="(+00)-123456789" placeholder="Phone number" autocomplete="tel">
                                                                                    </div>
                                                                                    <div class="col-12 col-md-6 col-xl-12 field-col">
                                                                                        <label for="address" class="field-label">Address</label>
                                                                                        <input type="text" id="address" name="address" class="w-100" value="Reliance GIDC" placeholder="Address line1" autocomplete="address-line1">
                                                                                    </div>
                                                                                    <div class="col-12 col-md-6 col-xl-12 field-col">
                                                                                        <label for="address2" class="field-label">Address2</label>
                                                                                        <input type="text" id="address2" name="address2" class="w-100" value="Chowk bazzar" placeholder="Address line2" autocomplete="address-line2">
                                                                                    </div>
                                                                                    <div class="col-12 field-col">
                                                                                        <label for="house-no" class="field-label">Apartment, suite, etc</label>
                                                                                        <input type="text" id="house-no" name="address3" class="w-100" value="7882" placeholder="Apartment, suite, etc" autocomplete="address-line3">
                                                                                    </div>
                                                                                    <div class="col-12 col-md-6 col-xl-12 field-col">
                                                                                        <label for="country" class="field-label">Country</label>
                                                                                        <select id="country" name="country" class="w-100" autocomplete="country">
                                                                                    ...
                                                                                    <div class="col-12 col-md-6 col-xl-12 field-col">
                                                                                        ...
                                                                                        <input type="text" id="province" name="province" class="w-100" value="Gujarat" placeholder="State" autocomplete="address-level1">
                                                                                    </div>
                                                                                    <div class="col-12 col-md-6 col-xl-12 field-col">
                                                                                        <label for="city" class="field-label">City</label>
                                                                                        <input type="text" id="city" name="city" class="w-100" value="Surat" placeholder="City" autocomplete="address-level2">
                                                                                    </div>
                                                                                    <div class="col-12 col-md-6 col-xl-12 field-col">
                                                                                        <label for="pincode" class="field-label">Pincode</label>
                                                                                        <input type="text" id="pincode" name="pincode" class="w-100" value="395006" placeholder="Pincode" autocomplete="postal-code">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="acc-radio-field mst-20 mst-md-30">
                                                                                    <ul class="acc-radio-ul ul-row">
                                                                                        <li class="acc-radio-li">
                                                                                            <label class="cust-radio-label">
                                                                                                <input type="radio" id="ship-home" name="ship" class="cust-checkbox" checked>
                                                                                                <span class="d-block cust-check"></span>
                                                                                                <span class="cust-text">Home<span class="cust-other-text">(All day delivery)</span></span>
                                                                                            </label>
                                                                                        </li>
                                                                                        <li class="acc-radio-li">
                                                                                            <label class="cust-radio-label">
                                                                                                <input type="radio" id="ship-work" name="ship" class="cust-checkbox">
                                                                                                <span class="d-block cust-check"></span>
                                                                                                <span class="cust-text">Work<span class="cust-other-text">(Delivery 10:00 AM - 05:00 PM)</span></span>
                                                                                            </label>
                                                                                        </li>
                                                                                    </ul>
                                                                                </div>
                                                                        ...
                                                                        <div class="acc-field-box">
                                                                            <h6 class="font-18 meb-21">Billing address</h6>
                                                                            <label class="cust-checkbox-label">
                                                                                <input type="checkbox" id="ship-address" name="ship-address" class="cust-checkbox" checked>
                                                                                <span class="d-block cust-check"></span>
                                                                                <span>Same as shipping address</span>
                                                                            </label>
                                                                            <div class="acc-detail-hide d-none mst-22">
                                                                                <div class="row field-row">
                                                                                    <div class="col-12 col-md-6 col-xl-12 field-col">
                                                                                        <label for="bill-name" class="field-label">Name</label>
                                                                                        <input type="text" id="bill-name" name="bill-name" class="w-100" placeholder="Your name" autocomplete="name">
                                                                                    </div>
                                                                                    <div class="col-12 col-md-6 col-xl-12 field-col">
                                                                                        <label for="bill-organization" class="field-label">Company (optional)</label>
                                                                                        <input type="text" id="bill-organization" name="bill-organization" class="w-100" placeholder="Company name" autocomplete="organization">
                                                                                    </div>
                                                                                    <div class="col-12 col-md-6 col-xl-12 field-col">
                                                                                        <label for="bill-email" class="field-label">Email</label>
                                                                                        <input type="email" id="bill-email" name="bill-email" class="w-100" placeholder="Email address" autocomplete="email">
                                                                                    </div>
                                                                                    <div class="col-12 col-md-6 col-xl-12 field-col">
                                                                                        <label for="bill-phone" class="field-label">Phone</label>
                                                                                        <input type="text" id="bill-phone" name="bill-phone" class="w-100" placeholder="Phone number" autocomplete="tel">
                                                                                    </div>
                                                                                    <div class="col-12 col-md-6 col-xl-12 field-col">
                                                                                        <label for="bill-address" class="field-label">Address</label>
                                                                                        <input type="text" id="bill-address" name="bill-address" class="w-100" placeholder="Address line1" autocomplete="address-line1">
                                                                                    </div>
                                                                                    <div class="col-12 col-md-6 col-xl-12 field-col">
                                                                                        <label for="bill-address2" class="field-label">Address2</label>
                                                                                        <input type="text" id="bill-address2" name="bill-address2" class="w-100" placeholder="Address line2" autocomplete="address-line2">
                                                                                    </div>
                                                                                    <div class="col-12 field-col">
                                                                                        <label for="bill-house-no" class="field-label">Apartment, suite, etc</label>
                                                                                        <input type="text" id="bill-house-no" name="bill-address3" class="w-100" placeholder="Apartment, suite, etc" autocomplete="address-line3">
                                                                                    </div>
                                                                                    <div class="col-12 col-md-6 col-xl-12 field-col">
                                                                                        <label for="bill-country" class="field-label">Country</label>
                                                                                        <select id="bill-country" name="bill-country" class="w-100" autocomplete="country">
                                                                                    ...
                                                                                    <div class="col-12 col-md-6 col-xl-12 field-col">
                                                                                        <label for="bill-province" class="field-label">State</label>
                                                                                        <input type="text" id="bill-province" name="bill-province" class="w-100" placeholder="State" autocomplete="address-level1">
                                                                                    </div>
                                                                                    <div class="col-12 col-md-6 col-xl-12 field-col">
                                                                                        <label for="bill-city" class="field-label">City</label>
                                                                                        <input type="text" id="bill-city" name="bill-city" class="w-100" placeholder="City" autocomplete="address-level2">
                                                                                    </div>
                                                                                    <div class="col-12 col-md-6 col-xl-12 field-col">
                                                                                        <label for="bill-pincode" class="field-label">Pincode</label>
                                                                                        <input type="text" id="bill-pincode" name="bill-pincode" class="w-100" placeholder="Pincode" autocomplete="postal-code">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="acc-radio-field mst-20 mst-md-30">
                                                                                    <ul class="acc-radio-ul ul-row">
                                                                                        <li class="acc-radio-li">
                                                                                            <label class="cust-radio-label">
                                                                                                <input type="radio" id="bill-home" name="bill" class="cust-checkbox" checked>
                                                                                                <span class="d-block cust-check"></span>
                                                                                                <span class="cust-text">Home<span class="cust-other-text">(All day delivery)</span></span>
                                                                                            </label>
                                                                                        </li>
                                                                                        <li class="acc-radio-li">
                                                                                            <label class="cust-radio-label">
                                                                                                <input type="radio" id="bill-work" name="bill" class="cust-checkbox">
                                                                                                <span class="d-block cust-check"></span>
                                                                                                <span class="cust-text">Work<span class="cust-other-text">(Delivery 10:00 AM - 05:00 PM)</span></span>
                                                                                            </label>
                                                                                        </li>
                                                                ...
                                                                <div class="acc-detail-button mst-20 mst-md-30">
                                                                    <div class="row btn-row">
                                                                        <div class="col-12 col-md-6 col-xl-12">
                                                                            <button type="submit" class="w-100 acc-save btn-style quaternary-btn">Save & continue</button>
                                                                        </div>
                                                                        <div class="col-12 col-md-6 col-xl-12">
                                                                            <button type="submit" class="w-100 acc-cancel btn-style secondary-btn">Cancel</button>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="checkout-other-info">
                                                    <div class="acc-info mst-30 pst-30 bst">
                                                        <div class="acc-title d-flex align-items-center justify-content-between">
                                                        ...
                                                        <div class="acc-detail mst-21">
                                                            <div class="acc-detail-info d-none">
                                                                ...
                                                                <div class="ul-mtm-15">
                                                                    <span>Please arrange the delivery as soon as possible, please leave the box on the porch behind the planter.</span>
                                                                </div>
                                                            ...
                                                            <div class="acc-detail-form">
                                                                <div class="acc-detail-field">
                                                                    <div class="row field-row">
                                                                        <div class="col-12 field-col">
                                                                            <label for="check-note" class="field-label">Order notes</label>
                                                                            <textarea rows="10" id="check-note" name="check-note" class="w-100" placeholder="Write your note here" autocomplete="off">Please arrange the delivery as soon as possible, please leave the box on the porch behind the planter.</textarea>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="acc-detail-button mst-20 mst-md-30">
                                                    ...
                                                    <div class="acc-detail mst-21">
                                                        <div class="acc-detail-info d-none">
                                                            ...
                                                            <div class="ul-mtm-15">
                                                                ...
                                                                <span>Estimated delivery date: 01/04/2021 09:00 AM - 05:00 PM</span>
                                                            </div>
                                                        ...
                                                        <div class="acc-detail-form">
                                                            <div class="acc-detail-field">
                                                                <div class="check-method">
                                                                    <span class="d-block meb-16">Choose a shipping method:</span>
                                                                    <div class="row row-mtm15">
                                                                        <div class="check-method-option">
                                                                            <div class="check-method-content ptb-15 plr-15 extra-bg border-radius">
                                                                                <div class="row">
                                                                                    <div class="col-9">
                                                                                        <div class="check-method-radio">
                                                                                            ...
                                                                                            <span class="d-block mst-7">Overnight one day shipping</span>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="col-3 text-end">
                                                                                        <span class="check-method-text text-danger">Paid</span>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="check-method-info mst-11">
                                                                                <div class="check-method-note">
                                                                                    <span class="float-start heading-color heading-weight mer-5">Note:</span>
                                                                                ...
                                                                                <div class="row">
                                                                                    <div class="col-9">
                                                                                        <div class="check-method-radio">
                                                                                            ...
                                                                                            <span class="d-block mst-7">2-3 business days</span>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="col-3 text-end">
                                                                                        <span class="check-method-text text-success">Free</span>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="check-method-info d-none mst-11">
                                                                                <div class="check-method-note">
                                                                                    <span class="float-start heading-color heading-weight mer-5">Note:</span>
                                                                                    ...
                                                                                    <div class="col-9">
                                                                                        <div class="check-method-radio">
                                                                                            <label class="cust-radio-label">
                                                                                                <input type="radio" name="delivery">
                                                                                                <span class="d-block cust-check"></span>
                                                                                                <span>Pickup available store</span>
                                                                                            </label>
                                                                                            <span class="d-block mst-7">Usually ready in 24 hours <a href="#pickup-availability-modal" data-bs-toggle="modal" class="pickup-availability heading-weight">Check availability at your nearest stores</a></span>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="col-3 text-end">
                                                                                        <span class="check-method-text text-success">Free</span>
                                                        ...
                                                        <div class="acc-detail-info d-none">
                                                            ...
                                                            <div class="st-payment mst-25">
                                                                <div class="st-img-num d-flex flex-wrap align-items-center">
                                                                    <span class="width-40"><img src="assets/image/other/paying-maestro.png" class="w-100 img-fluid border-radius" alt="paying-maestro"></span>
                                                                    <span class="width-calc-40 psl-15">xxxx 0446</span>
                                                                </div>
                                                                <div class="st-date mst-11">Expire date 07/23</div>
                                                            </div>
                                                                    ...
                                                                    <div class="row row-mtm15">
                                                                        <div class="check-method-option">
                                                                            <div class="check-method-content d-flex align-items-center justify-content-between ptb-15 plr-15 extra-bg border-radius">
                                                                                ...
                                                                                <div class="check-method-img ul-mt5 text-danger">
                                                                                    <span><img src="assets/image/other/paying-apple.png" class="width-40 img-fluid" alt="paying-apple"></span>
                                                                                </div>
                                                                            </div>
                                                                            <div class="check-method-info d-none mst-11 meb-15">
                                                                                <div class="check-method-note">
                                                                                    <span class="float-start heading-color heading-weight mer-5">Note:</span>
                                                                                    <span>After clicking on the button, you will be directed to a secure gateway for payment. After completing the payment process, you will be redirected back to the website to view details of your order.</span>
                                                                                </div>
                                                                                <div class="check-method-btn mst-11">
                                                                                    <div class="row btn-row">
                                                                                        <div class="col-12 col-md-6 col-lg-12">
                                                                                            <button type="button" class="w-100 btn-style apple-btn">Pay with <img src="assets/image/other/paying-applepay-btn.png" class="width-40 img-fluid" alt="paying-applepay-btn"></button>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        <div class="check-method-option">
                                                                            <div class="check-method-content d-flex align-items-center justify-content-between ptb-15 plr-15 extra-bg border-radius">
                                                                                <div class="check-method-radio">
                                                                                    <label class="cust-radio-label">
                                                                                        <input type="radio" name="pay" value="google">
                                                                                        <span class="d-block cust-check"></span>
                                                                                        <span>Google pay</span>
                                                                                    </label>
                                                                                </div>
                                                                                <div class="check-method-img ul-mt5 text-danger">
                                                                                    <span><img src="assets/image/other/paying-gpay.png" class="width-40 img-fluid" alt="paying-gpay"></span>
                                                                                </div>
                                                                            </div>
                                                                            <div class="check-method-info d-none mst-11 meb-15">
                                                                                <div class="check-method-note">
                                                                                ...
                                                                                <div class="check-method-btn mst-11">
                                                                                    <div class="row btn-row">
                                                                                        <div class="col-12 col-md-6 col-lg-12">
                                                                                            <button type="button" class="w-100 btn-style google-btn">Pay with <img src="assets/image/other/paying-gpay-btn.png" class="width-40 img-fluid" alt="paying-gpay-btn"></button>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        <div class="check-method-option">
                                                                            <div class="check-method-content d-flex align-items-center justify-content-between ptb-15 plr-15 extra-bg border-radius">
                                                                                ...
                                                                                <div class="check-method-img ul-mt5 text-danger">
                                                                                    <span><img src="assets/image/other/paying-bank.png" class="width-40 img-fluid" alt="paying-bank"></span>
                                                                                </div>
                                                                            </div>
                                                                            <div class="check-method-info d-none mst-11">
                                                                                <div class="check-method-note">
                                                                                ...
                                                                                <div class="check-method-btn mst-12 meb-15">
                                                                                    <div class="row row-mtm15">
                                                                                        <div class="col-12">
                                                                                            <div class="row field-row">
                                                                                                <div class="col-12 field-col">
                                                                                                    <label for="bank" class="field-label">Bank</label>
                                                                                                    <select id="bank" name="bank" class="w-100" autocomplete="off">
                                                                                        ...
                                                                                        <div class="col-12">
                                                                                            <div class="row btn-row">
                                                                                                <div class="col-12 col-md-6 col-lg-12 field-col">
                                                                                                    <button type="button" class="w-100 btn-style bank-btn">Proceed payment <img src="assets/image/other/paying-bank-btn.png" class="width-40 img-fluid" alt="paying-bank-btn"></button>
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                        ...
                                                                        <div class="check-method-option">
                                                                            <div class="check-method-content d-flex align-items-center justify-content-between ptb-15 plr-15 extra-bg border-radius">
                                                                                ...
                                                                                <div class="check-method-img ul-mt5 text-danger">
                                                                                    <span><img src="assets/image/other/paying-paypal.png" class="width-40 img-fluid" alt="paying-paypal"></span>
                                                                                </div>
                                                                            </div>
                                                                            <div class="check-method-info d-none mst-11 meb-15">
                                                                                <div class="check-method-note">
                                                                                ...
                                                                                <div class="check-method-btn mst-11">
                                                                                    <div class="row">
                                                                                        <div class="col-12 mst-1 meb-16">
                                                                                            <span class="d-block heading-color heading-weight meb-7">Select your paypal account type</span>
                                                                                            <div class="ul-mt30">
                                                                                                <label class="cust-radio-label">
                                                                                                    <input type="radio" id="domestic" name="account" value="type" checked>
                                                                                                    <span class="d-block cust-check"></span>
                                                                                                    <span>Domestic</span>
                                                                                                </label>
                                                                                                <label class="cust-radio-label">
                                                                                                    <input type="radio" id="international" name="account" value="type">
                                                                                                    <span class="d-block cust-check"></span>
                                                                                        ...
                                                                                        <div class="col-12">
                                                                                            <div class="row btn-row">
                                                                                                <div class="col-12 col-md-6 col-lg-12 field-col">
                                                                                                    <button type="button" class="w-100 btn-style paypal-btn">Pay with <img src="assets/image/other/paying-paypal-btn.png" class="width-40 img-fluid" alt="paying-paypal-btn"></button>
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                        ...
                                                                        <div class="check-method-option">
                                                                            <div class="check-method-content d-flex align-items-center justify-content-between ptb-15 plr-15 extra-bg border-radius">
                                                                                ...
                                                                                <div class="check-method-img ul-mt5 text-danger">
                                                                                    <span><img src="assets/image/other/paying-maestro.png" class="width-40 img-fluid" alt="paying-maestro"></span>
                                                                                    <span><img src="assets/image/other/paying-visa.png" class="width-40 img-fluid" alt="paying-visa"></span>
                                                                                </div>
                                                                            </div>
                                                                            <div class="check-method-info mst-11">
                                                                                <div class="check-method-note">
                                                                                ...
                                                                                <div class="check-method-card mst-22">
                                                                                    <div class="card-wrapper mtb-26"></div>
                                                                                    <div class="check-method-field">
                                                                                        <div class="row field-row">
                                                                                            <div class="col-12 col-md-6 col-xl-12 field-col">
                                                                                                <label for="cardnumber" class="field-label">Card number</label>
                                                                                                <input type="text" id="cardnumber" name="cardnumber" class="w-100" placeholder="Card number" autocomplete="cc-number">
                                                                                            </div>
                                                                                            <div class="col-12 col-md-6 col-xl-12 field-col">
                                                                                                <label for="ccname" class="field-label">Card Name</label>
                                                                                                <input type="text" id="ccname" name="ccname" class="w-100" placeholder="Card name" autocomplete="cc-name">
                                                                                            </div>
                                                                                            <div class="col-12 col-md-6 col-xl-12 field-col">
                                                                                                <label for="exp-date" class="field-label">Expire date</label>
                                                                                                <input type="text" id="exp-date" name="exp-date" class="w-100" placeholder="MM/YY" autocomplete="cc-exp">
                                                                                            </div>
                                                                                            <div class="col-12 col-md-6 col-xl-12 field-col">
                                                                                                <label for="cvc" class="field-label">CVV code</label>
                                                                                                <input type="text" id="cvc" name="cvc" class="w-100" placeholder="CVV" autocomplete="cc-csc">
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                    ...
                                    <div class="checkout-btn d-flex flex-column flex-md-row-reverse justify-content-md-between ptb-30 plr-15 plr-md-30 mst-30 extra-bg border-radius" data-animate="animate__fadeIn">
                                        <button type="button" onclick="window.location.href='order-complete.html'" class="width-100 width-md-auto btn-style secondary-btn">Place order</button>
                                        <a href="cart-page.html" class="body-primary-color d-flex align-items-center justify-content-center mst-15 mst-md-0"><i class="ri-arrow-left-line d-block icon-16 mer-5 lh-1"></i>Return to cart</a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<!-- Mirrored from spacingtech.com/html/erona/template/checkout.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 29 Oct 2025 07:45:23 GMT -->
</html>
