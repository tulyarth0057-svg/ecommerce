...
<head>
    ...
    <body>
        ...
        <div class="breadcrumb-area ptb-30 bg-img text-center" data-bgimg="assets/image/other/breadcrumb-bgimg.jpg">
            <div class="container">
                <span class="d-block extra-color"><a href="index.html" class="extra-color">Home</a> / Order</span>
                <h2 class="extra-color font-24 font-xl-32 mst-5 mst-xl-9">Order</h2>
            </div>
        </div>
        <!-- breadcrumb-area end -->
        <!-- main start -->
        <main id="main">
            <!-- order-page strat -->
            <section class="order-page section-ptb">
                <div class="container">
                    ...
                    <div class="order-area">
                        <!-- order-return account start -->
                        <div class="or-account peb-30 beb" data-animate="animate__fadeIn">
                            <a href="profile-order.html" class="body-primary-color text-decoration-underline">Return to account details</a>
                        </div>
                        <!-- order-return account end -->
                        <!-- order-detail start -->
                        <div class="order-detail">
                            <div class="od-wrap ptb-30 beb" data-animate="animate__fadeIn">
                                <div class="od-view ul-mtm30">
                                    <div class="od-id">
                                        <div class="row">
                                            <div class="col-6 col-lg-3">Order id</div>
                                            <div class="col-6 col-lg-3">
                                                <a href="order-info-default.html" class="d-inline-block body-primary-color text-decoration-underline">#1726</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="od-info">
                                        <div class="row row-mtm20">
                                            <div class="col-12 col-lg-6">
                                                <div class="row">
                                                    ...
                                                    <div class="col-6">24<sup>th</sup> Jan 2023</div>
                                                </div>
                                            </div>
                                            <div class="col-12 col-lg-6">
                                                <div class="row">
                                                    <div class="col-6">Payment</div>
                                                    <div class="col-6 text-success">COD</div>
                                                </div>
                                            </div>
                                            <div class="col-12 col-lg-6">
                                                <div class="row">
                                                    <div class="col-6">Total</div>
                                                    <div class="col-6">$245.00</div>
                                                </div>
                                            </div>
                                            <div class="col-12 col-lg-6">
                                                 <div class="row">
                                    ...
                                    <div class="od-link">
                                        <div class="row">
                                            <div class="col-6 col-lg-3">
                                                <a href="invoice.html" class="d-inline-block body-primary-color text-decoration-underline">View invoce</a>
                                            </div>
                                            <div class="col-6 col-lg-3">
                                                <a href="product.html" class="d-inline-block body-primary-color text-decoration-underline">Buy again</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="od-note">
                                        <span class="d-inline-block"><span class="heading-color heading-weight">Note:</span> Please arrange the delivery as soon as possible.</span>
                                    </div>
                                </div>
                                <div class="od-btn mst-26">
                                    <div class="row row-mtm15">
                                        <div class="col-12 col-md-6 col-xxl-3">
                                            <a href="#reviewmodal" class="w-100 btn-style quaternary-btn opacity-50 disabled" data-bs-toggle="modal">Write a review</a>
                                        </div>
                                        <div class="col-12 col-md-6 col-xxl-3">
                                            <a href="order-info-default.html" class="w-100 btn-style secondary-btn">Track order</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="od-view ul-mtm30">
                                    <div class="od-id">
                                        <div class="row">
                                            <div class="col-6 col-lg-3">Order id</div>
                                            <div class="col-6 col-lg-3">
                                                <a href="order-info-unfulfilled.html" class="d-inline-block body-primary-color text-decoration-underline">#1725</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="od-info">
                                        <div class="row row-mtm20">
                                            <div class="col-12 col-lg-6">
                                                <div class="row">
                                                    <div class="col-6">Date</div>
                                                    <div class="col-6">23<sup>rd</sup> Jan 2023</div>
                                                </div>
                                            </div>
                                            <div class="col-12 col-lg-6">
                                                <div class="row">
                                            ...
                                            <div class="col-12 col-lg-6">
                                                 <div class="row">
                                                    <div class="col-6">Status</div>
                                                    <div class="col-6">Unfulfilled</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="od-note">
                                        <span class="d-inline-block"><span class="heading-color heading-weight">Note:</span> Please arrange the delivery as soon as possible, Please leave the box on the porch behind the planter.</span>
                                    </div>
                                </div>
                                <div class="od-btn mst-26">
                                    <div class="row row-mtm15">
                                        ...
                                        <div class="col-12 col-md-6 col-xxl-3">
                                            <a href="order-info-unfulfilled.html" class="w-100 btn-style secondary-btn">Track order</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="od-view ul-mtm30">
                                    <div class="od-id">
                                        <div class="row">
                                            <div class="col-6 col-lg-3">Order id</div>
                                            <div class="col-6 col-lg-3">
                                                <a href="order-info-fulfilled.html" class="d-inline-block body-primary-color text-decoration-underline">#1724</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="od-info">
                                        <div class="row row-mtm20">
                                            <div class="col-12 col-lg-6">
                                                <div class="row">
                                                    <div class="col-6">Date</div>
                                                    <div class="col-6">22<sup>nd</sup> Jan 2023</div>
                                                </div>
                                            </div>
                                            <div class="col-12 col-lg-6">
                                                <div class="row">
                                    ...
                                    <div class="od-note">
                                        <span class="d-inline-block"><span class="heading-color heading-weight">Note:</span> Please arrange the delivery as soon as possible, Please keep safe.</span>
                                    </div>
                                </div>
                                <div class="od-btn mst-26">
                                    <div class="row row-mtm15">
                                        ...
                                        <div class="col-12 col-md-6 col-xxl-3">
                                            <a href="order-info-fulfilled.html" class="w-100 btn-style secondary-btn">Track order</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="od-view ul-mtm30">
                                    <div class="od-id">
                                        <div class="row">
                                            <div class="col-6 col-lg-3">Order id</div>
                                            <div class="col-6 col-lg-3">
                                                <a href="order-info-inprogress.html" class="d-inline-block body-primary-color text-decoration-underline">#1723</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="od-info">
                                        <div class="row row-mtm20">
                                            <div class="col-12 col-lg-6">
                                                <div class="row">
                                                    <div class="col-6">Date</div>
                                                    <div class="col-6">21<sup>st</sup> Jan 2023</div>
                                                </div>
                                            </div>
                                            <div class="col-12 col-lg-6">
                                                <div class="row">
                                    ...
                                    <div class="od-note">
                                        <span class="d-inline-block"><span class="heading-color heading-weight">Note:</span> Please arrange the delivery at my neighbour house, Because of at that time i am not available at home.</span>
                                    </div>
                                </div>
                                <div class="od-btn mst-26">
                                    <div class="row row-mtm15">
                                        ...
                                        <div class="col-12 col-md-6 col-xxl-3">
                                            <a href="order-info-inprogress.html" class="w-100 btn-style secondary-btn">Track order</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="od-view ul-mtm30">
                                    <div class="od-id">
                                        <div class="row">
                                            <div class="col-6 col-lg-3">Order id</div>
                                            <div class="col-6 col-lg-3">
                                                <a href="order-info-intransit.html" class="d-inline-block body-primary-color text-decoration-underline">#1722</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="od-info">
                                        <div class="row row-mtm20">
                                            <div class="col-12 col-lg-6">
                                                <div class="row">
                                                    <div class="col-6">Date</div>
                                                    <div class="col-6">20<sup>th</sup> Jan 2023</div>
                                                </div>
                                            </div>
                                            <div class="col-12 col-lg-6">
                                                <div class="row">
                                            ...
                                            <div class="col-12 col-lg-6">
                                                 <div class="row">
                                                    <div class="col-6">Status</div>
                                                    <div class="col-6">In transit</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="od-note">
                                        <span class="d-inline-block"><span class="heading-color heading-weight">Note:</span> Please arrange the delivery before evening at 6:00 p.m, Because of no one at home at that time.</span>
                                    </div>
                                </div>
                                <div class="od-btn mst-26">
                                    <div class="row row-mtm15">
                                        ...
                                        <div class="col-12 col-md-6 col-xxl-3">
                                            <a href="order-info-intransit.html" class="w-100 btn-style secondary-btn">Track order</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="od-wrap ptb-30 beb" data-animate="animate__fadeIn">
                                <div class="od-view ul-mtm30">
                                    <div class="od-id">
                                        <div class="row">
                                            <div class="col-6 col-lg-3">Order id</div>
                                            <div class="col-6 col-lg-3">
                                                <a href="order-info-indelivery.html" class="d-inline-block body-primary-color text-decoration-underline">#1721</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="od-info">
                                        <div class="row row-mtm20">
                                            <div class="col-12 col-lg-6">
                                                <div class="row">
                                                    <div class="col-6">Date</div>
                                                    <div class="col-6">19<sup>th</sup> Jan 2023</div>
                                                </div>
                                            </div>
                                            <div class="col-12 col-lg-6">
                                                <div class="row">
                                            ...
                                            <div class="col-12 col-lg-6">
                                                 <div class="row">
                                                    <div class="col-6">Status</div>
                                                    <div class="col-6">In delivery</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="od-btn mst-26">
                                    <div class="row row-mtm15">
                                        ...
                                        <div class="col-12 col-md-6 col-xxl-3">
                                            <a href="order-info-indelivery.html" class="w-100 btn-style secondary-btn">Track order</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="od-view ul-mtm30">
                                    <div class="od-id">
                                        <div class="row">
                                            <div class="col-6 col-lg-3">Order id</div>
                                            <div class="col-6 col-lg-3">
                                                <a href="order-info-cancel.html" class="d-inline-block body-primary-color text-decoration-underline">#1720</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="od-info">
                                        <div class="row row-mtm20">
                                            ...
                                            <div class="col-12 col-lg-6">
                                                <div class="row">
                                                    <div class="col-6">Payment</div>
                                                    <div class="col-6 text-danger">Refund</div>
                                                </div>
                                            </div>
                                            <div class="col-12 col-lg-6">
                                                <div class="row">
                                    ...
                                    <div class="od-note">
                                        <span class="d-inline-block"><span class="heading-color heading-weight">Note:</span> Please cancel my order and give me refund because of i don't like the product.</span>
                                    </div>
                                </div>
                                <div class="od-btn mst-26">
                                    <div class="row row-mtm15">
                                        ...
                                        <div class="col-12 col-md-6 col-xxl-3">
                                            <a href="order-info-cancel.html" class="w-100 btn-style secondary-btn">Track order</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="od-view ul-mtm30">
                                    <div class="od-id">
                                        <div class="row">
                                            <div class="col-6 col-lg-3">Order id</div>
                                            <div class="col-6 col-lg-3">
                                                <a href="order-info-pickup.html" class="d-inline-block body-primary-color text-decoration-underline">#1719</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="od-info">
                                        <div class="row row-mtm20">
                                            <div class="col-12 col-lg-6">
                                                <div class="row">
                                                    <div class="col-6">Date</div>
                                                    <div class="col-6">18<sup>th</sup> Jan 2023</div>
                                                </div>
                                            </div>
                                            <div class="col-12 col-lg-6">
                                                <div class="row">
                                            ...
                                            <div class="col-12 col-lg-6">
                                                 <div class="row">
                                                    <div class="col-6">Status</div>
                                                    <div class="col-6">Pickup at store</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="od-note">
                                        <span class="d-inline-block"><span class="heading-color heading-weight">Note:</span> Please ready to my order as soon as possible, I will be their to pickup by myself.</span>
                                    </div>
                                </div>
                                <div class="od-btn mst-26">
                                    <div class="row row-mtm15">
                                        <div class="col-12 col-md-6 col-xxl-3">
                                            <a href="#reviewmodal" class="w-100 btn-style quaternary-btn" data-bs-toggle="modal">Write a review</a>
                                        </div>
                                        <div class="col-12 col-md-6 col-xxl-3">
                                            <a href="order-info-pickup.html" class="w-100 btn-style secondary-btn">Track order</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="od-view ul-mtm30">
                                    <div class="od-id">
                                        <div class="row">
                                            <div class="col-6 col-lg-3">Order id</div>
                                            <div class="col-6 col-lg-3">
                                                <a href="order-info-delivered.html" class="d-inline-block body-primary-color text-decoration-underline">#1718</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="od-info">
                                    ...
                                    <div class="od-note">
                                        <span class="d-inline-block"><span class="heading-color heading-weight">Note:</span> Please arrange the delivery as soon as possible, I need urgent.</span>
                                    </div>
                                </div>
                                <div class="od-btn mst-26">
                                    <div class="row row-mtm15">
                                        ...
                                        <div class="col-12 col-md-6 col-xxl-3">
                                            <a href="order-info-delivered.html" class="w-100 btn-style secondary-btn">Track order</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <nav aria-label="Page navigation example">
                                <ul class="pagination ul-mt5 align-items-center justify-content-center pagination-box">
                                    <li class="page-item first">
                                        <a href="javascript:void(0)" class="page-link p-0 m-0 bg-transparent border-0 lh-1" aria-label="First page">First</a>
                                    </li>
                                    <li class="page-item prev">
                                        <a href="javascript:void(0)" class="page-link icon-16 d-flex align-items-center justify-content-center p-0 m-0 bg-transparent border-0 border-radius" aria-label="Previous"><i class="ri-arrow-left-line d-block lh-1"></i></a>
                                    </li>
                                    <li class="page-item">
                                    ...
                                    <li class="page-item next">
                                        <a href="javascript:void(0)" class="page-link icon-16 d-flex align-items-center justify-content-center p-0 m-0 bg-transparent border-0 border-radius" aria-label="Next"><i class="ri-arrow-right-line d-block lh-1"></i></a>
                                    </li>
                                    <li class="page-item last">
                                        <a href="javascript:void(0)" class="page-link p-0 m-0 bg-transparent border-0 lh-1" aria-label="Last page">Last</a>
                                    </li>
                                </ul>
                            </nav>
                        </div>
                ...
                <!-- review-modal start -->
                <div class="review-modal modal fade" id="reviewmodal">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content body-bg border-0 br-hidden">
                            <div class="modal-body ptb-30 plr-15 plr-md-30">
                                <form method="post">
                                    <div class="review-modal-header d-flex align-items-center justify-content-between meb-30">
                                        <h6 class="font-18">Back to order</h6>
                                    ...
                                    <div class="review-modal-form">
                                        <div class="row field-row">
                                            ...
                                            <div class="col-12 field-col">
                                                ...
                                                <input type="text" id="name" name="name" class="w-100" placeholder="Demo name" autocomplete="name">
                                            </div>
                                            <div class="col-12 field-col">
                                                <label for="name" class="field-label">Email</label>
                                                <input type="email" id="email" name="email" class="w-100" placeholder="demo@demo.com" autocomplete="email">
                                            </div>
                                            <div class="col-12 field-col">
                                                <label for="name" class="field-label">Review title</label>
                                                <input type="text" id="title" name="title" class="w-100" placeholder="Review title" autocomplete="name">
                                            </div>
                                            <div class="col-12 field-col">
                                                <label for="message" class="field-label">Message</label>
                                                <textarea rows="5" id="message" name="message" class="w-100" placeholder="Review message" autocomplete="off"></textarea>
                                            </div>
                                        </div>
                                        <div class="review-modal-button mst-20 mst-md-30">
                                            <div class="row btn-row">
                                                <div class="col-12 col-md-6">
                                                    <button type="submit" class="w-100 btn-style quaternary-btn">Submit review</button>
                                                </div>
                                                <div class="col-12 col-md-6">
                                                    <button type="button" class="w-100 btn-style secondary-btn" data-bs-dismiss="modal">Cancel</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
